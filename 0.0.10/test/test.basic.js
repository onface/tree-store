...
describe('TreeStore', function () {
					...
					describe('API Tests', function () {
										...
										it('TreeStore(data).getChildIds(Array)', function () {
															expect(JSON.stringify(tree.getChildIds(['1_1', '2', '3']))).to.equal(JSON.stringify([["1_1_1", "1_1_2"], ["2_1", "2_2"], []]));
										});
										...
										it('TreeStore(data).getChildAllIds(Array)', function () {
															expect(JSON.stringify(tree.getChildAllIds(['1_1', '2', '3']))).to.equal(JSON.stringify([["1_1_1", "1_1_2", "1_1_1_1", "1_1_1_2"], ["2_1", "2_2"], []]));
										});
										...
										it('TreeStore(data).getParentAllIds(Array)', function () {
															expect(JSON.stringify(tree.getParentAllIds(['2', '1_1_2']))).to.equal(JSON.stringify([[], ["1_1", "1"]]));
										});
										it('TreeStore(data).getChildLeftBranchIds(String)', function () {
															expect(JSON.stringify(tree.getChildLeftBranchIds('1'))).to.equal(JSON.stringify([["1_1", "1_2"], ["1_1_1", "1_1_2"], ["1_1_1_1", "1_1_1_2"]]));
										});
										it('TreeStore(data).getChildLeftBranchIds(null)', function () {
															expect(JSON.stringify(tree.getChildLeftBranchIds())).to.equal(JSON.stringify([["1", "2", "3"], ["1_1", "1_2"], ["1_1_1", "1_1_2"], ["1_1_1_1", "1_1_1_2"]]));
										});
