	...
	;(function addData (data){
		data.forEach(function(item){
			...
			if(item.id == id){
				...
				if(Array.isArray(item.child)){
                    let originIdMap = {}
                    item.child.forEach(function(originItem,originIndex){
                        originIdMap[originItem.id] = originIndex
                    })
                    TreeStore.treeMap(childData,'child',function(outputItem){
                        ...
                        if(exist){
                            ...
                            item.child[ originIdMap[outputItem.id] ] = extend(true,{},outputItem)
                        }else{
                            item.child.push( extend(true,{},outputItem) )
                        }
                    })
				}else{
